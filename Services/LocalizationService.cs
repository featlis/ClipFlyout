...
public class LocalizationService
{
    ...
    private readonly Dictionary<string, Translation> _strings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "Setting_WidgetAutoAlign", new("トレイの隠しアイコン (^) 左隣に自動吸着", "Auto-dock to hidden tray icons (^) left") },
        { "Setting_WidgetAutoAlign_Desc", new("トレイアイコンの増減に合わせて被らないよう自動で追従します", "Automatically tracks tray size to avoid overlapping tray buttons") },
        { "Setting_WidgetMonitor", new("ウィジェットを表示するモニター", "Widget Display Monitor") },
        { "Setting_WidgetMonitor_Desc", new("マルチモニター環境でウィジェットを配置するディスプレイを選択します", "Select which display monitor hosts the taskbar widget") },
        { "Setting_WidgetTextColor", new("ウィジェットの文字色", "Widget Text Color") },
        { "Setting_WidgetTextColor_Desc", new("タスクバーの明るさに合わせた自動検知、または固定色（白・黒）を選択します", "Choose auto-detection based on taskbar luminance, or fixed white/black") },
        { "Widget_TextColor_Auto", new("自動検知 (タスクバー色に最適化) [既定]", "Auto (Detect Taskbar) [Default]") },
        { "Widget_TextColor_Light", new("常に白 (ダーク系タスクバー向け)", "Always White (For dark taskbar)") },
        { "Widget_TextColor_Dark", new("常に黒 (ライト系タスクバー向け)", "Always Dark (For light taskbar)") },
        ...
        { "Widget_Monitor_Header", new("表示モニター", "Monitor") },
        { "Widget_Monitor_Primary", new("メインモニター [既定]", "Primary Monitor [Default]") },
        { "Widget_Monitor_Cursor", new("マウスカーソルのあるモニター", "Active Cursor Monitor") },
        { "Widget_Monitor_Display1", new("ディスプレイ 1", "Display 1") },
        { "Widget_Monitor_Display2", new("ディスプレイ 2", "Display 2") },
        { "Widget_Monitor_Display3", new("ディスプレイ 3", "Display 3") },
